...
const Auth = () => {
  ...
  return (
    <div className={`authContainer h-screen relative`}>
      ...
      <div
        className={`absolute top-1/2 left-1/2 transform -translate-x-1/2  -translate-y-1/2 box flex flex-col justify-center items-center  h-[33rem] w-[90%] vs:w-[90%] sm:w-[30rem] md:w-[30rem]  rounded-md z-50 shadow-2xl shadow-white border-2 px-2 md:px-8 `}
      >
         <CustomeToast show={auth.error} message={auth.error?.error}/>
     

        <h1 className="text-2xl md:text-4xl font-bold pb-8">Abi Trade</h1>
        {/* <Avatar>
