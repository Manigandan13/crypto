    ...
    <>
      {coin.loading ? (
        ...
        <div className="p-5 mt-5">
          <div className="flex justify-between md:flex-row flex-col gap-y-10">
            ...
            <div className="flex items-center gap-5">
              ...
              <Dialog>
                <DialogTrigger>
                  <Button size="lg" className="rounded-sm">Trade Now</Button>
                </DialogTrigger>
                <DialogContent className="w-[90%] vs:w-[85%] md:w-[50%]">
                  <DialogHeader className="">
                    <DialogTitle className="pt-3 text-center text-xs md:text-sm">
