...
const Wallet = () => {
  ...
  return (
    <div className="flex flex-col items-center p-3">
      <div className="pt-10 px-1 w-full lg:w-[60%]">
        <Card className="pl-3 py-5 border border-black">
          ...
          <CardContent>
            ...
            <div className="flex gap-5 mt-5 flex-wrap vs:flex-nowrap ">
              <Dialog className="">
                <DialogTrigger>
                  <div className="h-24 w-24 md:w-28 md:h-24 hover:text-gray-400 cursor-pointer flex flex-col items-center justify-center rounded-xl border border-black ">
                    <UploadIcon />
                    <span className="text-xs md:text-sm mt-2">Add Money</span>
                  </div>
                </DialogTrigger>
                <DialogContent className="w-[90%] vs:w-[85%] md:w-[50%] rounded">
                  <DialogHeader>
              ...
              <Dialog>
                <DialogTrigger>
                  <div className="h-24 w-24 md:w-28 md:h-24 hover:text-gray-400 cursor-pointer flex flex-col items-center justify-center rounded-2xl border border-black">
                    <DownloadIcon />
                    <span className="text-xs md:text-sm mt-2">Withdraw</span>
                  </div>
                </DialogTrigger>
                <DialogContent className="w-[90%] vs:w-[85%] md:w-[50%] rounded">
                  <DialogHeader>
              ...
              <Dialog>
                <DialogTrigger>
                  <div className="h-24 w-24 md:w-28 md:h-24 hover:text-gray-400 cursor-pointer flex flex-col items-center justify-center rounded-2xl border border-black ">
                    <ShuffleIcon />
                    <span className="text-xs md:text-sm mt-2">Transfer</span>
                  </div>
                </DialogTrigger>
                <DialogContent className="p-10 w-[90%] vs:w-[85%] md:w-[50%] rounded">
                  <DialogHeader>
                    <DialogTitle className="text-center text-xs md:text-sm ">
        ...
        <div className="py-5 pt-10">
          <div className="flex gap-2 items-center pb-5">
            ...
            <UpdateIcon
              ...
              className="p-0 h-5 w-5 cursor-pointer hover:text-gray-400"
            />
          </div>
          ...
          <div className="space-y-5">
            {wallet.transactions?.map((item, index) => (
              <div key={index}>
                <Card className="lg:w-[50] px-5 py-5 flex justify-between items-center border border-black">
                  <div className="flex items-center gap-5">
                    <Avatar>
                      <AvatarFallback>
                        <ShuffleIcon />
                    ...
                    <div className="space-y-1">
                      <h1 className="text-xs md:text-sm">{item.type || item.purpose}</h1>
