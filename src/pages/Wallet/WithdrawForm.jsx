...
const WithdrawForm = () => {
  ...
  return (
    <div className="pt-10 space-y-5">
      <div className="flex justify-between items-center rounded-md text- text-xl font-bold px-5 py-4">
        <p className="text-xs md:text-sm">Available balance</p>
        <p className="text-xs md:text-sm">${wallet.userWallet?.balance}</p>
      </div>
      <div className="flex flex-col items-center">
        <h1 className="text-xs md:text-sm font-semibold">Enter withdrawal amount</h1>

        <div className="flex items-center justify-center ">
          <Input
            onChange={handleChange}
            value={amount}
            className="withdrawInput py-7 border-none outline-none focus:outline-none px-0 text-xs md:text-sm text-center "
            placeholder="$9999"
            type="number"
          />
        </div>
      ...
      <div>
        <p className="pb-2 text-xs md:text-sm">Transfer to</p>
      ...
      <DialogClose className="w-full">
        <Button
          ...
          variant=""
          className="w-full py-3 text-xs md:text-sm"
        >
