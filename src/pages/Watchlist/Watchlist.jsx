...
const Watchlist = () => {
  ...
  return (
    <div className="pt-8 px-3 lg:px-10">
      ...
      <Table className="px-5 lg:px-20 border-t relative border-x border-b p-10 text-xs md:text-sm">
          ...
          <TableBody className="">
            {watchlist.items.map((item) => (
              <TableRow className="" key={item.id}>
                ...
                <TableCell className="hidden md:table-cell">{item.total_volume}</TableCell>
                <TableCell className="hidden md:table-cell">{item.market_cap}</TableCell>
                <TableCell
